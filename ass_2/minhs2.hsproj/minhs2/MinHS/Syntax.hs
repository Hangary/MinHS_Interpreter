...
-- QType is mainly for Polymorphism
-- Forall should only be introduced for '*let* f = (recfun ...)', where a function might be called more than once
-- Usage: Forall "a" (Forall "b" (Ty (Prod (TypeVar "a") (TypeVar "b"))))
...
-- allows you to update each type annotation in an expression, making it easy to perform this substitution.
